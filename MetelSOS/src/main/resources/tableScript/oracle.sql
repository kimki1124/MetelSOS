...
CREATE TABLE METELSOS_LEFTMENU(
...
MENU_ENG_TITLE VARCAHR(50),
CONSTRAINT FK_MENU_PARENT FOREIGN KEY(MENU_PARENT_CODE)
REFERENCES METELSOS_LEFTMENU(MENU_CODE),
...
VALUES(0, 'ROOT', NULL, 0, 0, 'N');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '메인화면', 0, 1, 1, 'Y');

UPDATE METELSOS_ENGINEER_LEFTMENU SET MENU_CODE = 1 WHERE MENU_TITLE = '메인화면';

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.CURRVAL, '지원 업무', 0, 2, 1, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '유지보수 지원 사항', 2, 1, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '미지원 업무 조회', 2, 2, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '내부 자료', 0, 3, 1, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '내부 회의록', 5, 1, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '트러블 슈팅', 5, 2, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '기술 자료', 5, 3, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, 'BMT', 0, 4, 1, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '2013년', 9, 1, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '2014년', 9, 2, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '2015년', 9, 3, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '2016년', 9, 4, 2, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '엔지니어 검색', 0, 5, 1, 'Y');

INSERT INTO METELSOS_ENGINEER_LEFTMENU
VALUES(SEQ_ENGINEER_MENU_CODE.NEXTVAL, '고객 검색', 0, 6, 1, 'Y');
...
INSERT INTO METELSOS_CUSTOMER_LEFTMENU
VALUES(SEQ_CUSTOMER_MENU_CODE.NEXTVAL, '메인화면', 0, 1, 1, 'Y');

UPDATE METELSOS_CUSTOMER_LEFTMENU SET MENU_CODE = 1 WHERE MENU_TITLE = '메인화면';

INSERT INTO METELSOS_CUSTOMER_LEFTMENU
VALUES(SEQ_CUSTOMER_MENU_CODE.CURRVAL, '지원 요청', 0, 2, 1, 'Y');

INSERT INTO METELSOS_CUSTOMER_LEFTMENU
VALUES(SEQ_CUSTOMER_MENU_CODE.NEXTVAL, '지원 히스토리', 0, 3, 1, 'Y');

INSERT INTO METELSOS_CUSTOMER_LEFTMENU
VALUES(SEQ_CUSTOMER_MENU_CODE.NEXTVAL, '엔지니어 검색', 0, 4, 1, 'Y');

INSERT INTO METELSOS_CUSTOMER_LEFTMENU
VALUES(SEQ_CUSTOMER_MENU_CODE.NEXTVAL, '자주묻는 질문', 0, 5, 1, 'Y');
