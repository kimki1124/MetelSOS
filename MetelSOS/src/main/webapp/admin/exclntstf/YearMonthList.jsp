...
<body class="">
											...
											<table class="table table-bordered">
												...
												<tbody>
													<c:forEach var="i" begin="1" end="12" step="1">
														<tr>
															<td style="text-align:center;"><a href="javascript:moveExclntStfListPage('${currYear }', '${i }');" >${currYear}년 ${i }월 우수사원</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
		...
		<script type="text/javascript">
		  	...
		  	function moveExclntStfListPage(year, month){
	  			...
	  			comSubmit.addParam('menuTitle', encodeURI(year+"년 "+month+"월 우수사원 "));
