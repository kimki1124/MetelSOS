		...
		<script>
			...
			$(document).ready(function(){
				$('#delete_check_dialog').dialog({
					...
					resizable: false,
					modal : true,
					title:"<div class='widget-header'><h4><i class='fa fa-warning'></i>&nbsp;지원 요청</h4></div>",
					buttons:[{
						...
						click:function(){
							...
							//support_history삭제
							$.ajax({
								url:"/metelSOS/deleteSupportHistory.do",
								type:'POST',
								dataType:'json',
								data:{ "supportNum" : '${supportVo.support_num }' },
									...
									<div class="widget-body">
										<form id="supportReqForm" class="smart-form">
											...
											<fieldset>
												...
												<section>
													<label class="label"><strong>상태</strong></label>
													<label class="input">
														<input type="text" name="support_state" value="${supportVo.support_state }" readonly="readonly">
													</label>
												</section>
											</fieldset>
											<fieldset>
