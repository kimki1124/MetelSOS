...
<body class="">
		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<div id="fullscreen" class="btn-header transparent pull-right">
					<span> <a href="javascript:void(0);" data-action="launchFullscreen" title="Full Screen" style="padding:5px;"><i class="fa fa-arrows-alt"></i></a> </span>
				</div>
		...
		<aside id="left-panel">
			...
			<!-- User info -->
			<!-- <div class="login-info"> 로그인 시 사용자 이름
