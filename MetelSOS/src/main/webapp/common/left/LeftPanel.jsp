		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					...
					<li class="">
						<a href="#" title="blank_"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">유지보수 지원 사항</span></a>
					</li>
					<li class="">
						<a href="#" title="blank_"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">미지원 업무 조회</span></a>
					</li>
					<li class="">
						<a href="#" title="blank_"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">내부 회의록</span></a>
					</li>
					<li class="">
						<a href="#" title="blank_"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">엔지니어 검색</span></a>
					</li>
					<li class="">
						<a href="#" title="blank_"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">고객사 검색</span></a>
					</li>
				</ul>
			</nav>

			<span class="minifyme" data-action="minifyMenu" style="padding:5px;"> <i class="fa fa-arrow-circle-left hit"></i> </span>
