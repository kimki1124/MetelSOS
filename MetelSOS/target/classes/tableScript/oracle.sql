...
EXCLNT_YEAR_MONTH VARCHAR(14) NOT NULL,
ENGINEER_NAME VARCHAR(20),
ENGINEER_DEPT VARCHAR(50),
ENGINEER_IMAGE_NAME VARCHAR(100),
ENGINEER_IMAGE_CONTENT BLOB,
IMPRESSION_SPEECH CLOB NOT NULL,
ENGINEER_POSITION VARCHAR(20) NOT NULL,
CONSTRAINT FK_EXCLNT_NAME FOREIGN KEY(ENGINEER_NAME)
REFERENCES METELSOS_ENGINEER(ENGINEER_NAME),
CONSTRAINT FK_EXCLNT_DEPT FOREIGN KEY(ENGINEER_DEPT)
REFERENCES METELSOS_ENGINEER(ENGINEER_DEPT)
);

-- 신입사원 정보 관리 테이블 
CREATE TABLE METELSOS_NEW_EMPLYD(
NEW_EMPLY_YEAR_MONTH VARCHAR(14) NOT NULL,
ENGINEER_NAME VARCHAR(20),
ENGINEER_DEPT VARCHAR(50),
ENGINEER_IMAGE_NAME VARCHAR(100),
ENGINEER_IMAGE_CONTENT BLOB,
IMPRESSION_SPEECH CLOB NOT NULL,
ENGINEER_POSITION VARCHAR(20) NOT NULL,
CONSTRAINT FK_NEW_EMPLY_NAME FOREIGN KEY(ENGINEER_NAME)
REFERENCES METELSOS_ENGINEER(ENGINEER_NAME),
CONSTRAINT FK_NEW_EMPLY_DEPT FOREIGN KEY(ENGINEER_DEPT)
REFERENCES METELSOS_ENGINEER(ENGINEER_DEPT)
);
